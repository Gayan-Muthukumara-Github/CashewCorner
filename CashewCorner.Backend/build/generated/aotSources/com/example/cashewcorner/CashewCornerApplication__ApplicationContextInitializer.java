 ...
 */
@Generated
public class CashewCornerApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CashewCornerApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CashewCornerApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.example.cashewcorner.config.SecurityConfig");
    mappings.put("org.springframework.security.config.annotation.method.configuration.PrePostMethodSecurityConfiguration", "com.example.cashewcorner.config.SecurityConfig");
