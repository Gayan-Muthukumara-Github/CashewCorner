...
public class PurchaseOrderService {
    ...
    private PurchaseOrderDto mapToDto(PurchaseOrder order) {
        return PurchaseOrderDto.builder()
                ...
                .isApproved(order.getIsApproved())
                .quantity(order.getQuantity())
                .quality(order.getQuality())
                .costPerUnit(order.getCostPerUnit())
                .season(order.getSeason())
                .paymentMethod(order.getPaymentMethod())
                .distance(order.getDistance())
                .deliveryMethod(order.getDeliveryMethod())
                .deliveryCost(order.getDeliveryCost())
                .timeTakenToReceive(order.getTimeTakenToReceive())
                .averageCostPerUnit(order.getAverageCostPerUnit())
                .averageDeliveryTime(order.getAverageDeliveryTime())
                .averageDeliveryCost(order.getAverageDeliveryCost())
                .performances(order.getPerformances())
